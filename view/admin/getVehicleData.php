	...
	$("input:checkbox").on('click', function() {
		...
		$("#vehicle_search_form").submit(function( event ) {
			...
			var $vehicleData = $.post('http://localhost/admin/vehicles/getVehicleDataResult', {'vehicleRegistration' : $("#vehicleSearchRegistration").val()}, function(vehicleDataResponse) {
				...
				//for(var i = 0; i< vehicleDataResponse.length; i++) {
				//	$("#vehicleDataResponse").append(vehicleDataResponse[i]);
				//}

				//$("#vehicleDataResponse").append(JSON.stringify(vehicleDataResponse));

				let obj = vehicleDataResponse;

				//alert(obj.Response.DataItems.TechnicalDetails.Performance.Power.Bhp);
				
				console.log(obj.Response.DataItems.VehicleRegistration.Vrm);
        ...
        <div id="content">
            ...
            <form id="vehicle_form" method="POST" action="<?php echo URL; ?>/admin/vehicles/addVehicle" enctype="multipart/form-data">
				...
				<table id="vehicleTable">
					...
					<tr><td>Vehicle Variant:</td><td><input type="text" value="" id="vehicleVariant" name="vehicleVariant"></td></tr>
					...
					<tr><td>Vehicle Colour:</td><td><input type="text" value="" id="vehicleColour" name="vehicleColour"></td></tr>
